...
import placeholderimg from "../../../images/placeholder-images/placeholder-frozen.png";
...
const FrozenMenuComponent = (props) => {
    const { isAuthenticated, loginWithRedirect } = useAuth0();
    const frozenItems = props.searchBase === 'kitchen' ? props.frozen.items : props.allKitchensMenu.frozen.items;
    ...
    return (
        <div className='container'>
            <Scrollbars style={{ height: "60vh" }} className="menu-without-add-btn  mobile-background" id='itemsDays'>
                <KitchenName />
                {(props.isMenuItemFetching || props.isMenuFetching || props.isKitchensFetching)
                    ...
                    : <div className='row mx-0 mt-2 cardMargin'>
                        {frozenItems.length ? frozenItems.map((items, index) => {
                            return <React.Fragment key={index}>
                                ...
                                <div className="col-lg-4 col-md-6 singleColumn itemsCardMargin col-6 mt-3">
                                    <div onMouseEnter={() => { setIsHover(true); }} onMouseLeave={() => { setIsHover(false); }} className="kitchenHomeCard hoverList">
                                                ...
                                                <Scrollbars className="scrollbar" style={{ minHeight: '22vh', maxHeight: '22vh' }}>
                                                    <table className="table table-borderless hover-table color-red-second" style={{ color: "black" }}>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>Weight</td>
                                                                <td className="text-right">{items.weight}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={2} className="pb-0">Description</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={2} className="desc-style">{items.description}</td>
                                                            </tr>
                                                            {(props.type === 'supplier') ? <tr>
                                                                <td>Tags</td>
                                                ...
                                                <div className="col-md-5 col-5 pl-3 text-right pr-2 pt-custom py-3" style={{ padding: "0px 0px 0px 10px" }} >
                                                    {(props.type === 'supplier')
                                                        ? <div className='btn-alignment' >
                                                            ...
                                                            <button onClick={() => props.onSelectItems(items)} data-toggle="modal" data-target="#freozenUpdate">Update</button>
                                                        </div>
                                ...
                                {/* update item modal  */}
                                <div className="modal" id="freozenUpdate" >
                        ...
                        }) : props.frozenMenuKitchens.map((kitchen, index) => {
...
export default connect(mapStateToProps, null)(FrozenMenuComponent);